...
public class BookingDetailFragment extends DialogFragment {
    ...
    public BookingDetailFragment newInstance (String response, String booking_id) {
        BookingDetailFragment f = new BookingDetailFragment ();
        Bundle args = new Bundle ();
        args.putString ("arrayResponse", response);
        args.putString (AppConfigTags.BOOKING_ID, booking_id);
        f.setArguments (args);
        return f;
    }
    ...
    private void initBundle () {
        ...
        booking_id = bundle.getString (AppConfigTags.BOOKING_ID);
        ...
        tvScan.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick (View view) {
                if (numberOfItem == scanItem) {
                    Toast.makeText (getActivity (), "Maximum number of item already scanned.", Toast.LENGTH_LONG).show ();
                } else {
    ...
    private void setData () {
        try {
            ...
            for (int i = 0; i < jsonArrayBooking.length (); i++) {
                ...
                if (jsonObjectBooking.getString (AppConfigTags.BOOKING_ID).equalsIgnoreCase (booking_id)) {
                    tvBookingId.setText ("Booking Id : " + jsonObjectBooking.getString (AppConfigTags.BOOKING_ID));
                    ...
                    tvTitle.setText ("Booking Id : " + jsonObjectBooking.getString (AppConfigTags.BOOKING_ID));
